  ...
  return (
    <div className="max-w-[650px] mx-auto py-12 px-4 animate-vix-in">
      <div className="flex flex-col gap-2 mb-10 text-center md:text-left">
        <h2 className="text-3xl font-black uppercase tracking-[0.3em] text-[var(--vix-text)]">Search</h2>
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          <div className="text-center py-24 animate-in fade-in zoom-in duration-500">
             ...
             <p className="text-zinc-500 text-[11px] font-black uppercase tracking-[0.5em]">No users found</p>
          </div>
        )}
      </div>
    </div>
