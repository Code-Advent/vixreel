...
const Notifications: React.FC<NotificationsProps> = ({ currentUser, onOpenAdmin }) => {
  return (
    <div className="max-w-[600px] mx-auto py-8 px-4">
      <div className="flex justify-between items-center mb-8">
        ...
        {currentUser.is_admin && (
          <button 
            onClick={onOpenAdmin}
            className="flex items-center gap-2 vix-gradient px-4 py-2 rounded-xl text-white font-bold text-sm shadow-xl shadow-pink-500/20 hover:scale-105 transition-transform"
          >
      ...
      <div className="flex flex-col items-center justify-center py-20 text-stone-500 text-center">
        ...
        <p className="max-w-xs">When people like your posts or follow you, you'll see it here.</p>
      </div>
    </div>
  );
};
