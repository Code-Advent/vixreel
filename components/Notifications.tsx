  ...
  return (
    <div className="max-w-[600px] mx-auto py-8 px-4 relative animate-vix-in">
      <div className="flex justify-between items-center mb-8">
        <h2 className="text-2xl font-bold uppercase tracking-widest text-[var(--vix-text)]">Notifications</h2>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-20 text-zinc-500 text-center">
        ...
        <h3 className="text-xl font-black text-[var(--vix-text)] mb-3 uppercase tracking-tight">No signals detected</h3>
